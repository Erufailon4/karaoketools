...
from common import getconfigdir, getsongsdir, getmaterialsdir, writetofile
import argparse
...
def main():
    ...
    ap.add_argument("-o", "--option", choices=["songsdir", "materialsdir"], help="name of the option to view/modify")
    ...
    if not args.mode:
        ...
        try:
            print(f"materialsdir: {getmaterialsdir()}")
        except:
            print("No materialsdir defined")
        return
    match args.mode:
        case "view":
            if args.option and args.option == "songsdir":
                try:
                    ...
                    print("No songsdir defined")
            elif args.option and args.option == "materialsdir":
                try:
                    print(f"materialsdir: {getmaterialsdir()}")
                except:
                    print("No materialsdir defined")
        ...
        case "modify":
            ...
            elif args.option and args.value and args.option == "materialsdir":
                writetofile(getconfigdir().joinpath("materialsdir.txt"), args.value)
            else:
